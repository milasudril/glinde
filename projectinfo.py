...
#ifndef GLINDE_PROJECTINFO_HPP
#define GLINDE_PROJECTINFO_HPP
...
try:
	...
	keys=json.load(open('projectinfo.json',encoding='utf-8'))
	keys['scriptname']=sys.argv[0]
	keys['version']=gitVersionGet()
	keys['now']=time.strftime('%Y-%m-%d %H:%M %Z')
	with open(filename_out,mode='w',encoding='utf-8') as filehandle:
