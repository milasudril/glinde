...
ResourceManagerDefault::ResourceManagerDefault(Filesystem& source):r_source(source)
	{
...
ResourceManagerDefault::~ResourceManagerDefault()
	{}


const ItemClass& ResourceManagerDefault::itemClassGet(const Stringkey& classname) const
	{
...
const Model& ResourceManagerDefault::modelGet(const char* sibling_file,const char* filename)
	{
...
const Image& ResourceManagerDefault::textureGet(const char* sibling,const char* filename)
	{
...
SiteDefault& ResourceManagerDefault::siteGet(const Stringkey& mapname,World& world_notify)
	{
