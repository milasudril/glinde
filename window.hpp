...
#ifndef GLFWMM_NO_CALLBACK_ADVERTISMENT
#define ADVERTISE_MEMBER(membername) [[deprecated("Hint: add " #membername " to `Callback`.")]]
#else
...
namespace GLFWmm
	...
	class Window:public WindowBase
		...
		private:
			...
			template<class S=Callback, typename cb_test<decltype(&S::positionChanged)>::type=0>
			...
			template<class S=Callback, typename cb_test<decltype(&S::sizeChanged)>::type=0>
			...
			template<class S=Callback, typename cb_test<decltype(&S::closing)>::type=0>
			...
			template<class S=Callback, typename cb_test<decltype(&S::refresh)>::type=0>
			...
			template<class S=Callback, typename cb_test<decltype(&S::focusChanged)>::type=0>
			...
			template<class S=Callback, typename cb_test<decltype(&S::iconified)>::type=0>
			...
			template<class S=Callback, typename cb_test<decltype(&S::framebufferSizeChanged)>::type=0>
